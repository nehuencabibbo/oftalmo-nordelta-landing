  ...
  return (
    ...
    >
      ...
      <div className="z-10 text-center px-4 w-full max-w-4xl mx-auto flex flex-col gap-5">
        <h1 className="text-shadow-lg/20 text-8xl max-[32rem]:text-7xl font-semibold">
          Oftalmo Nordelta
        </h1>
        <p className="text-shadow-lg text-lg max-[32rem]:text-md tracking-wide px-5 sm:px-20 xl:px-25">
