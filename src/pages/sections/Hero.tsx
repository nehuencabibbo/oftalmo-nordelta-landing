    ...
    >
      ...
      <div className="z-10 text-center px-4 max-w-4xl mx-auto flex flex-col gap-5">
        ...
        <p className="text-shadow-lg text-md tracking-wide px-35">
          Cuidando la visión de nuestros pacientes hace más de <span className="font-bold text-accent">7 años</span>. Junto a profesionales con más de <span className="font-bold text-accent">20 años</span> de experiencia. 
        </p>
      </div>
    </section>
  );
