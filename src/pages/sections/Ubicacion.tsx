...
export default function Ubicacion() {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-10 md:gap-12 w-full max-w-6xl">
        <div className="flex flex-col gap-2">
          <h2 className="text-center text-custom-white text-5xl font-semibold text-shadow-md">
            Ubicación
          </h2>
          <p className="tracking-wide text-center text-custom-white max-w-3xl mx-auto text-md leading-relaxed text-shadow-md">
            Nos encontramos en {" "}
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-stretch w-full">
          <div className="relative flex-1">
            <div className="relative h-full min-h-[360px] md:min-h-[480px] lg:min-h-[620px] rounded-3xl overflow-hidden shadow-2xl border border-border">
              <iframe
          ...
          <div className="flex flex-col gap-10 lg:w-[32%]">
            <section className="flex flex-col gap-4 text-custom-white">
              <h3 className="text-lg font-semibold tracking-wide">
                ¿Dónde estamos?
              </h3>
              <div className="flex flex-col gap-4">
                <div className="flex items-start gap-3">
                  <MapPin size={26} className="shrink-0 text-accent mt-1" />
                ...
                <div className="flex items-start gap-3">
                  <Building2 size={26} className="shrink-0 text-accent mt-1" />
                  <p className="text-sm text-custom-white/80 leading-relaxed">
            ...
            <section className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-sm text-custom-white/80 leading-relaxed text-justify">
